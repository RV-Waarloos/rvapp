...
<body class="antialiased">
    <div class="min-h-screen xl:max-w-7xl mx-auto border-2">
        <div class="flex flex-col-reverse justify-between w-screen h-screen sm:block sm:relative"
            x-data="{ open: true }">
            <button @click="open = !open"
                class="block w-full px-4 py-2 text-gray-900 bg-white shadow-2xl sm:mr-4 sm:rounded-full sm:mb-4 sm:w-56 sm:right-0 sm:bottom-0 sm:absolute focus:outline-none focus:shadow-outline">
                <span x-show="open == true">Switch to Sidebar</span>
                <span x-show="open == false">Switch to Navbar</span>
            </button>
            <div x-show="open === true"
                ...
                <div x-data="{ open: false }"
                    ...
                    <div class="flex flex-row items-center justify-between p-4">
                        <a href="#"
                            class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">RV
                            Waarloos</a>
            ...
            <div class="flex justify-items-around">
                <div x-show="open === false" class="border-2 border-green-500 p-6 flex-col  md:flex md:flex-row md:min-h-screen">
                ...
                <div class="border-2 border-yellow-500 px-8 mx-8">
                    {{ $slot }}
                </div>
            </div>
        </div>
