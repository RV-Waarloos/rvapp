    ...
    <div
      ...
      style="background-image: url({{ Vite::asset('resources/images/chalet.jpg') }})">
      {{-- <img src = "{{ Vite::asset('resources/images/chalet.jpg') }}" /> --}}
      <h1
        ...
        <span class="inline md:block">Welkom bij RV Waarloos</span>
      </h1>
