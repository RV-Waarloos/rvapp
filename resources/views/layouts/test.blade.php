            ...
            <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800 border-2 border-green-300">
                <div x-data="{ open: false }" class="border-2 border-red-600 flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
                    ...
                    <nav :class="{'flex': open, 'hidden': !open}" class="border-2 border-yellow-400 flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
                        ...
                        {{-- Menu options --}}
                        <x-navigation.menuitem label="Blog" route="test"/>
                        <x-navigation.menuitem label="Tapkalender" route="test2"/>

                        {{-- Dropdown --}}
                        <x-navigation.menudropdown label="Beheer Leden"
                            
                        >
                            <x-navigation.menudropdownitem label="Overzicht" route="test2"/>
                            <x-navigation.menudropdownitem label="Nieuw lid" route="test2"/>
                            <x-navigation.menudropdownitem label="Nieuwe leden opladen" route="test2"/>
                            <x-navigation.menudropdownitem label="Nieuwe leden registraties" route="test2"/>
                        </x-navigation.menudropdown>

                        {{-- Grid dropdown --}}
                        <x-navigation.menugriddropdown label="Afdelingen" :abc="'a'" >

                        </x-navigation.menugriddropdown>
